...
static const char qt_meta_stringdata_EzNoteNames[] = {
    "EzNoteNames\0\0sendNewInd(int)\0"
    "recieveTextNotes(std::vector<EzNote*>)\0"
...
void EzNoteNames::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sendNewInd((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->recieveTextNotes((*reinterpret_cast< std::vector<EzNote*>(*)>(_a[1]))); break;
        case 2: _t->recievePianoKey((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void EzNoteNames::sendNewInd(int _t1)
{
